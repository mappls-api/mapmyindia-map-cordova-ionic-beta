...
var mmi = (function () {
    ...
    mmi.prototype.loadMaps = function (id,params) {
        if (params.key) { 
            ...
            global.mmi_tl=L.tileLayer((map_tile=map_tile+params.key) +"/"+(L.Browser.retina?'retina_map':'still_map')+'/{z}/{x}/{y}.png', {subdomains:subd,maxZoom: 18,  minZoom: 4});map_sdk.addLayer(global.mmi_tl);
